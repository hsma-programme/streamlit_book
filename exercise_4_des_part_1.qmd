...
Below is a more advanced version of the discrete event simulation from HSMA session 2B.
...
Try to make it so that the model does not run without a button being pressed.
